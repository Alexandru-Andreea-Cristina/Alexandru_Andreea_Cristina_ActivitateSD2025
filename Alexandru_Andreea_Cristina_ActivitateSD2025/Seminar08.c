...
//	FILE* file = fopen(numeFisier, "r"); //am deschsi fisierul
//	int index = 0;
//	while (!feof(file)) {
...
//	heap.nrMasini = index;
//
//	fclose(file);  //pt cine trebuie sa facem filtrarea
...
//	Masina aux = heap->masini[0]; //il diferentiem
